...
import { LoaderComponentService } from "../../dashboard/shared/behavior-subject-service/loader-component-interaction.service";
...
export class FullLayoutComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewChecked() {
    this.loaderComponentService.changeEmitted.subscribe(data => {
      // console.log("FullLayoutComponent "+ data)
      this.loading = data
    })
